    ...
    <div className="container">
      ...
      <div className="row d-flex mx-auto justify-content-center">
        {!!trips && trips.length > 0 ? (
          trips.map((trip, i) => {
            if (
              trip.country === user_trip.country_trip &&
              trip.city === user_trip.capital_trip &&
              trip.start_date === user_trip.start_date
            ) {
              return (
                  ...
                  <div className="trip_card card border-0 mb-5 justify-content-center">
                    ...
                    <div className="card-body d-flex p-0">
                      <div className="w-100 text-center p-3">
                        {!!allUsers && allUsers.length > 0 ? (
                          allUsers.map((user, i) => {
                            if (user.id === trip.users_id) {
                              return (
                                <p key={i} className="trip_text card-text px-2">
                        ...
                        <p>
                          {" "}
                          goes to {trip.capital_trip}, {trip.country_trip} on
                          the same date!
                        </p>
                      </div>
                    </div>
